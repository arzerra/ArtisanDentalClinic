        ...
        <div className="w-full flex flex-col items-center justify-start bg-gray-100 pb-[100px] overflow-x-hidden">
            ...
            <div  className="max-w-[1200px] mt-10 sm:mt-10 w-full px-4 sm:px-10">
                ...
                {/* <ul className="font-['Quicksand'] text-gray-600 text-sm grid grid-cols-1 gap-10 place-items-center mt-10">
                        ...
                        <div className="flex flex-col w-full">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2">
                                <div className="flex flex-col items-start text-left mt-0 sm:mt-3 mx-10">
                                    <img src="/images/pages/appointment/bg/sms.svg" alt="Appointment" className="w-50 sm:w-100 h-50 sm:h-100 mx-auto" data-aos="fade-up"/>
                                </div>
                    ...
                    {/* <li className="max-w-[1100px] w-full flex justify-center items-center py-8 bg-white shadow-md rounded-2xl p-4 hover:shadow-lg transition overflow-hidden">
                    <div className="flex flex-col w-full">
                        <h1 
                        className="font-['Quicksand'] text-2xl sm:text-3xl font-semibold text-gray-900 text-center mt-3 mb-10" 
                        data-aos="zoom-in-up"
                        ...
                        <div className="flex flex-col items-center sm:items-start text-center sm:text-left mt-0 sm:mt-3 px-4 sm:px-6">
                            <img 
                            src="/images/pages/appointment/bg/sms.svg" 
                            alt="Appointment" 
                            className="w-32 sm:w-48 h-auto max-w-full mx-auto" 
                            data-aos="fade-up"
                            />
                        </div>
                        <div className="flex flex-col justify-center text-sm sm:text-xl text-left px-4 sm:px-6" data-aos="fade-up">
                            <SmsForm/>
                        </div>
                        </div>
                    </div>
                ...
                <div className="max-w-[1080px] w-full h-auto sm:h-[130px] bg-white shadow-md rounded-4xl mt-20 mx-auto flex flex-col sm:flex-row items-center sm:justify-between justify-center text-center px-6 sm:px-10 py-6 sm:py-6">
                    <p className="text-gray-700 text-2xl sm:text-3xl font-medium mb-4 sm:mb-0" data-aos="fade">
